...
def build_account_costs_by_account(cost_and_usage, account_list, daily_average=False):
    account_costs: dict = {}
...
def build_cost_matrix_by_account(account_costs, account_name_list):
    cost_matrix: dict = {}
...
def monthly_costs_by_account(
    ...
    account_costs, account_name_list = build_account_costs_by_account(
    ...
    account_cost_matrix = build_cost_matrix_by_account(account_costs, account_name_list)
...
def build_account_names(cost_matrix):
    account_names: list = []
...
def main():
    ...
    for run_mode in run_modes:
        ...
        match run_mode:
            # by Account
            case "account":
                cost_matrix = monthly_costs_by_account(
                    ce_client,
                    o_client,
                    start_date,
                    end_date,
                ...
                account_names = build_account_names(cost_matrix)
